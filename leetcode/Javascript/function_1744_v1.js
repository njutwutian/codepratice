...
var canEat = function(candiesCount, queries) {
    ...
    for (let index = 0; index < len; index++) {
        ...
        let cap = element[2];
        if (candiesCount[favouriteType] <= favouriteDay || candiesCount[favouriteType -1] >= (favouriteDay + 1) * cap) {
            result[index] = false;
        }
    }
    return result;
